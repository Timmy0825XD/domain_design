...
sealed class EstadoAlerta with _$EstadoAlerta {
  ...
  const factory EstadoAlerta.moderada(String recomendacion) = Moderada;
  ...
  @Assert('motivo != ""', 'descartar exige un motivo')
  const factory EstadoAlerta.descartada(String motivo) = Descartada;
